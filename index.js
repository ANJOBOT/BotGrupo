		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerB: '[❗] Este comando só pode ser usado pelo Vitinn! ❌',
			...
			const ownerNumber = ["5598989016015@s.whatsapp.net"] // replace this with your number
							   ...
							   reply(anu.result.jadwalTV)
								break
											case 'afk':
													...
													const tag = {
															text: `@${nom.split("@s.whatsapp.net")[0]} *TO AFK ${tels} NAUM PERTUBEM*`,
